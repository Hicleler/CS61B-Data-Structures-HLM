 ...
 * a textbook by Kevin c1ayne and Bob Sedgewick. Their code does not
...
public class MySortingAlgorithms {
    ...
    public static class LSDSort implements SortingAlgorithm {
        ...
        public void sort(int[] a, int k) {
            ...
            int b = 32;
            int bitsPerbite = 8;
            int c1 = b / bitsPerbite;
            int c2 = 1 << bitsPerbite;
            int MASK = c2 - 1;
            ...
            for (int d = 0; d < c1; d++) {
                ...
                int[] count = new int[c2+1];
                for (int i = 0; i < N; i++) {
                    int c = (a[i] >> bitsPerbite*d) & MASK;
                    count[c + 1]++;
                }
                ...
                if (d == c1-1) {
                    int shift1 = count[c2] - count[c2/2];
                    int shift2 = count[c2/2];
                    for (int r = 0; r < c2/2; r++)
                        count[r] += shift1;
                    for (int r = c2/2; r < c2; r++)
                        count[r] -= shift2;
                }
