...
public class RuntimeQuiz {
     ...
     */
    public static Runtime f1_omega_runtime = Runtime.LOG_N;
    public static Runtime f1_o_runtime = Runtime.LINEARITHMIC;
    ...
    public static Runtime f2_omega_runtime = Runtime.LINEARITHMIC;
    ...
    public static Runtime f3_o_runtime = Runtime.LINEARITHMIC;
    ...
    public static Runtime f5_omega_runtime = Runtime.CONSTANT;
    public static Runtime f5_o_runtime = Runtime.LINEAR;
    ...
    public static Runtime f6_omega_runtime = Runtime.LOG_N;
    public static Runtime f6_o_runtime = Runtime.LINEARITHMIC;
    ...
    public static Runtime f7_o_runtime = Runtime.QUADRATIC;
    public static Runtime f7_theta_runtime = Runtime.LINEARITHMIC;
